...
class _TimetableRepository implements TimetableRepository {
  ...
  Future<AddTimetableResponseModel> addTimetable(
      {required AddTimetableDto addTimetableDto}) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{r'accessToken': 'true'};
    _headers.removeWhere((k, v) => v == null);
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<AddTimetableResponseModel>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = AddTimetableResponseModel.fromJson(_result.data!);
    return value;
  }
